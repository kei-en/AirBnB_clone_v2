...
class test_basemodel(unittest.TestCase):
    ...
    def test_pycodestyle(self):
        ...
        Test pep8 format
        """
        pycstyle = pycodestyle.StyleGuide(quiet=True)
        result = pycstyle.check_files(['models/base_model.py'])
    ...
    def test_uuid(self):
        ...
        list_instances = [instance_1, instance_2,
                          instance_3]
    ...
    def test_str_method(self):
        ...
        instance_6 = BaseModel()
        string_output = "[BaseModel] ({}) {}".format(instance_6.id,
                                                     instance_6.__dict__)
        self.assertEqual(string_output, str(instance_6))
